...
public class PublishVacancyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        addSessionAttribute("recruiter", postingRecruiter, request.getSession());
    ...
    private List getRequiredQualifications(HttpServletRequest request) {
        ...
        System.out.println("Done getting required qualifications in " + getClass().getSimpleName() + " the list is " + qualificationsList.toString());
